  ...
  if (animatedElements.length > 0) {
    ...
    if ('IntersectionObserver' in window) {
      ...
      function isElementInViewport(el) {
        ...
        return rect.top <= windowHeight - 60 && rect.bottom >= 0;
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "יעל רום 5 פתח תקווה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2a10d945-b464-4ccd-a990-314f32532134',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2a10d945-b464-4ccd-a990-314f32532134';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2a10d945-b464-4ccd-a990-314f32532134';
